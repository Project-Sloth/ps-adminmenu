<script lang="ts">
  import { resourceStore, visibility } from '../store/stores';
...
<div class="report-container">
  ...
  <div class="message-container">
    ...
    <div class="message {message.sent ? 'sent' : ''}">
      <div class="message-header">{#if message.header}{message.header} - {/if}{#if message.timestamp}{message.timestamp.time}{/if}</div>
...
<div class="container {isMenuLarge ? 'open' : ''}">
  <div class="sidebar">
    ...
    <button on:click={toggleMenu}>
      <i class="fas fa-angle-left" id="icon" style="margin-bottom: 21.6rem;transform: rotate({isMenuLarge ? 180 : 0}deg);"></i>
    </button>
  </div>
...
{#if currentPage === 'wizard'}
  <div class="menu">
    <div class="button-container" style="display: flex; justify-content: flex-start; align-items: center; margin-top: -14px; margin-left: -10px;">
      ...
      {/if}
        ...
        <div style="background-color: var(--color-3); padding-top: 5rem;padding-left: 5rem;padding-right: 5rem;padding-bottom: 4rem;height: 40px; overflow: hidden; transition: height 1.5s ease-in-out;">
      ...
      {/if}
        ...
        <div style="background-color: var(--color-3);padding-top: 5rem;padding-left: 5rem;padding-right: 5rem;padding-bottom: 0rem; height: 25px; overflow: hidden; transition: height 1.5s ease-in-out;">
            <!-- Your dropdown menu content goes here -->
            <div style="display: flex; flex-direction: column; justify-content: flex-start; margin-top: -4rem; margin-left: -4rem">
              <input type="text" placeholder="ID" style="color: var(--textcolor);font-family: 'Roboto', sans-serif;outline: none;background-color: var(--color-2);padding: 0.5rem; margin-bottom: 0.5rem; border-radius: 0.15rem; border: none;">
      ...
      <div style="background-color: var(--color-3); padding-top: 5rem;padding-left: 5rem;padding-right: 5rem;padding-bottom: 1.5rem;height: 40px; overflow: hidden; transition: height 1.5s ease-in-out;">
        <!-- Your dropdown menu content goes here -->
        <div style="display: flex; flex-direction: column; justify-content: flex-start; margin-top: -4rem; margin-left: -4rem">
    ...
    {/if}
      ...
      <div style="background-color: var(--color-3); padding-top: 5rem;padding-left: 5rem;padding-right: 5rem;padding-bottom: 0rem;height: 27px; overflow: hidden; transition: height 1.5s ease-in-out;">
        <!-- Your dropdown menu content goes here -->
        <div style="display: flex; flex-direction: column; justify-content: flex-start; margin-top: -4rem; margin-left: -4rem">
